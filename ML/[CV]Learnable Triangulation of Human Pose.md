...
그런 다음 copr된 이미지 셋인 I_c를 심층 CNN backbone에 집어넣는다. 이 CNN backbone은 < Simple baselines for human pose estimation and tracking. > 논문의 간단한 baseline 모델 아키텍처에 기반한 것이다.  
